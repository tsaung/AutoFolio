...
test('visitor chat: sends message and receives response (mocked)', async ({ page }) => {
...
test('visitor chat: clicking prompt triggers chat', async ({ page }) => {
    ...
    await expect(page.getByText('Tell me about your experience', { exact: true })).toBeVisible();
